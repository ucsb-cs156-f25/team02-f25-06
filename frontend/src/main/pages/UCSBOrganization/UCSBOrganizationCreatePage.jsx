...
export default function UCSBOrganizationCreatePage({ storybook = false }) {
  ...
  const onSuccess = (ucsbOrganization) => {
    toast(
      `New UCSB Organization Created - orgCode: ${ucsbOrganization.orgCode} orgTranslationShort: ${ucsbOrganization.orgTranslationShort} orgTranslation: ${ucsbOrganization.orgTranslation}`,
    );
  };
