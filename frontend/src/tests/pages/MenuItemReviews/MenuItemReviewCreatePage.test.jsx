...
describe("MenuItemReviewCreatePage tests", () => {
  ...
  test("on submit, makes request to backend, and redirects to /menuitemreviews", async () => {
    ...
    expect(axiosMock.history.post[0].params).toEqual({
      itemId: "7",
      reviewerEmail: "juliasmom@gmail.com",
      stars: "5",
      dateReviewed: "2025-11-01T23:04",
      comments: "this was so nutritious for my young julia",
    });

    // assert - check that the toast was called with the expected message
    expect(mockToast).toBeCalledWith(
      "New menuItemReview Created - id: 3 stars: 1",
    );
