...
describe("MenuItemReviewIndexPage tests", () => {
  ...
  test("renders three reviews correctly for regular user", async () => {
    ...
    ).toHaveTextContent("julia_lin@ucsb.edu");

    const stars = screen.getByText("5");
    expect(stars).toBeInTheDocument();

    const dateReviewed = screen.getByText("2025-11-02T06:01:44.307");
    expect(dateReviewed).toBeInTheDocument();

    const comments = screen.getByText("so delicious i think i saw god");
