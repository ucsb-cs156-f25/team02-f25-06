...
describe("UCSBDiningCommonsMenuItemForm tests", () => {
  ...
  const expectedHeaders = ["Dining Commons Code", "Item Name", "Station"];
  ...
  test("that the correct validations are performed", async () => {
    ...
    fireEvent.change(diningCommonsCodeInput, { target: { value: "a".repeat(11) } });
    fireEvent.click(submitButton);
    ...
    const itemNameInput = screen.getByTestId(`${testId}-name`);
