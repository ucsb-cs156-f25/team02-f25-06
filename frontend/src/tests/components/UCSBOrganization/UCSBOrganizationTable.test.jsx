...
describe("UCSBOrganizationTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    ).toHaveTextContent("Associated Students");
    expect(
      screen.getByTestId(`${testId}-cell-row-0-col-orgTranslation`),
    ).toHaveTextContent("Associated Students UCSB");
    expect(
    ...
    ).toHaveTextContent("Gaucho Racing");
    expect(
      screen.getByTestId(`${testId}-cell-row-1-col-orgTranslation`),
    ).toHaveTextContent("Collegiate Chapter of SAE International at UCSB");
    expect(
